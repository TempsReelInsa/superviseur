...
#define DBG_ALL (DBG_WATCHDOG | DBG_SEND_MONITOR | DBG_CONNECT_ROBOT | DBG_RECV_MONITOR | DBG_MOVE_ROBOT | DBG_BATTERY_STATE | DBG_IMAGE | DBG_STATUS)

#define DEBUG_WHAT DBG_ALL & ~DBG_RECV_MONITOR & ~DBG_SEND_MONITOR
